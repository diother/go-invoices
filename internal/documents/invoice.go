...
func (s *DocumentService) GenerateInvoice(donation *dto.FormattedDonation) (pdf *gopdf.GoPdf, err error) {
	pdf = &gopdf.GoPdf{}
...
// func (s DocumentService) addHeader(pdf *gopdf.GoPdf, invoice *models.Invoice) error {
...
func (s DocumentService) addFooter(pdf *gopdf.GoPdf) error {
	const endY = marginBottom

	err := addImage(pdf, "./static/images/hintermann-logo-small.png", marginLeft, 796, 138, 14)
	if err != nil {
		return err
	}
